    ...
    {    
        ...
        if(Gate::allows('is-admin')){
            if ($organizationID == $orgId) {
                ...
                $getActiveMembership = Non_Academic_Membership::where('academic_membership_id','!=',$id)->where('am_status','=','Active')->select('am_status')->first();
                $getExistingMemberships = Non_Academic_Membership::where('academic_membership_id','!=',$id)->get();
                $membershipExist = false;
                
                if($data['status'] == 'Ended'){
                    Non_Academic_Membership::where('non_academic_membership_id',$id)->update([
