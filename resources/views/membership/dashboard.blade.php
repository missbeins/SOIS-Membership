            ...
            <div class="list-group list-group-flush my-3" id="myList">
                @can('is-admin')
                    @can('is-academic')
                        ...
                        <div class="dropdown-container">
                            ...
                            <a href="{{ route('membership.admin.academic.academicapplication.declinedApplications') }}"><i class="fas fa-user-times  me-2"></i>Declined Applications</a>
                        </div>
                        <button class="dropdown-btn second-text fw-bold"><i
                ...
                @can('is-student')
                    ...
                    <div class="dropdown-container">
                        ...
                        <a href="{{ route('membership.user.nonacademic.my-applications') }}"><i class="fas fa-user-check me-2"></i>Non-academic</a></a>
                    </div>
                    <button class="dropdown-btn second-text fw-bold"><i
