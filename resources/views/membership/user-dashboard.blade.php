    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                <a class="second-text brand" href="/membership"><i class="fas fa-swatchbook me-2"></i>Membership</a>
            </div>
            <div class="list-group list-group-flush my-3" id="myList">
                @can('is-student')
                    <a href="{{ route('user.my-organizations') }}"
                        class="list-group-item list-group-item-action  second-text active "><i
