        ...
        <nav aria-label="breadcrumb align-items-center">
            <ol class="breadcrumb justify-content-center ">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('membership.adviser.nonacademic.index') }}" class="text-decoration-none">Back</a>
                </li>
            </ol>
        </nav>
    </div>
                    ...
                    @if ($members->isNotEmpty())
                        @foreach ($members as $member)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('membership.nonacademic.members-details', $member->academic_member_id) }}" type="button" class="btn btn-info"><i class="far fa-eye me-2"></i>Details</a>
                                </td>
