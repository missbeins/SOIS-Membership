                            ...
                            @if ($academic_memberships->isNotEmpty())
                                @foreach ($academic_memberships as $membership)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('membership.adviser.memberships-members', $membership->academic_membership_id) }}" type="button" class="btn btn-info"><i class="fas fa-eye me-2"></i>Members</a>

                                            <a href="{{ route('membership.adviser.memberships-details', $membership->academic_membership_id) }}" type="button" class="btn btn-info"><i class="fas fa-eye me-2"></i>Details</a>
                                         ...
                                         --}}<a href="{{ route('membership.adviser.generateMembershipPDF', $membership->academic_membership_id) }}" class="btn btn-warning"><i class="fas fa-file-pdf me-2"></i>Generate PDF</a>
