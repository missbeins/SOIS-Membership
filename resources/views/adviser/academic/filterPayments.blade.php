           ...
           <nav aria-label="breadcrumb align-items-center">
               <ol class="breadcrumb justify-content-center ">
                   ...
                   <li class="breadcrumb-item">
                       <a href="{{route('membership.adviser.academic.payment-details')}}" class="text-decoration-none">Back</a>
                   </li>
    ...
    <div class="card">
        <div class=" card-header text-light" style="background-color: #c62128">
            <div class="row">
                ...
                <form class="col-md-4 input-group" style="width:30%" action="{{ route('membership.adviser.academic.filterPayment') }}" method="get">
        ...
        <div class="card-body table-responsive text-center">        
            @if (isset($paidmembers))
                <table class="table table-light table-sm table-striped table-hover table-responsive" id="filterpayments">
                    <thead>
                        <tr>
...
@section('scripts')
    <script type="module">
        ...
        window.addEventListener('DOMContentLoaded', event => {
            const dataTable = new simpleDatatables.DataTable("#filterpayments", {
                perPage: 5,
                searchable: true,
                labels: {
