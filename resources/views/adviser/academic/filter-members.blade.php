        ...
        <nav aria-label="breadcrumb align-items-center">
            <ol class="breadcrumb justify-content-center ">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('membership.adviser.academic.members')}}" class="text-decoration-none">Back</a>
                </li>
    ...
    <div class="card">
        <div class=" card-header text-light" style="background-color: #c62128">
            <div class="row">
                ...
                <form class="col-md-4 input-group" style="width:30%; height:5px;" action="{{ route('membership.admin.academic.academicmember-filter') }}" method="get">
                    @csrf
        ...
        <div class="card-body table-responsive text-center">
            ...
            <table class="table table-light table-sm table-striped table-hover" id="filter">
                <thead>
                    <tr>
...
@section('scripts')
    <script type="module">
        ...
        window.addEventListener('DOMContentLoaded', event => {
            const dataTable = new simpleDatatables.DataTable("#filter", {
                perPage: 5,
                searchable: true,
                labels: {
