<!-- Modal -->
<div class="modal fade" id="report{{$membership->academic_membership_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="pdf-form" action="{{  route('membership.adviser.academic.generateMembershipPDFperYearLevel')  }}" method="POST">
            @csrf
