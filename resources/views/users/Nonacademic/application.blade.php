...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3" method="POST" action="{{ route('membership.user.nonacademic.application-store') }}">
                @csrf
                ...
                <div class="col-md-6">
                    ...
                    <select id="membership_id" class="form-select" name="membership_id" required>
                        @foreach ($nonacademic_memberships as $nonacademic_membership)
                            <option value="{{ $nonacademic_membership->non_academic_membership_id }}">{{ $nonacademic_membership->semester }}({{ $nonacademic_membership->membership_start_date }} to {{ $nonacademic_membership->membership_end_date }})</option>
