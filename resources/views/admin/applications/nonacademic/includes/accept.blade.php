  ...
  <div class="modal fade" id="accept{{ $application->application_id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="text-start"action="{{ route('membership.admin.nonacademic.nonacademicapplication.accept', [$application->application_id, $application->organization_id]) }}" method="POST">
            @method('PUT')
            @csrf
