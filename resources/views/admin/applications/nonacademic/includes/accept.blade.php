    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="row g-3 text-start"action="{{ route('membership.admin.nonacademic.nonacademicapplication.accept', [$application->application_id, $application->organization_id]) }}" method="POST">
                @method('PUT')
                @csrf
