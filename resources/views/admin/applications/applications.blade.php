                        ...
                        @foreach ($acad_applications as $application)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{ $application->application_id }}">
                                            <i class="fas fa-user-check"></i> Accept
                                        </button>
                                        @include('admin.applications.includes.accept')

                                        <!-- Button trigger accept modal -->
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{ $application->application_id }}">
                                        ...
                                        <form class="d-none" id="delete-membership-form-{{ $application->application_id }}"
                                            action="{{ route('membership.admin.academicapplication.destroy', $application->application_id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form> --}}
