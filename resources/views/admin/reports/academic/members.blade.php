        ...
        <nav aria-label="breadcrumb align-items-center">
            <ol class="breadcrumb justify-content-center ">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('membership.admin.academic.memberships-reports') }}" class="text-decoration-none">Back</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card-body table-responsive text-center">
                ...
                <thead>
                    <tr> 
                        ...
                        <th class="col-sm-2">Year and Section</th>
                    ...
                    @if ($members->isNotEmpty())
                        @foreach ($members as $member)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('membership.admin.academic.members-details', $member->academic_member_id) }}" type="button" class="btn btn-info"><i class="far fa-eye me-2"></i>Details</a>
                                </td>
