    ...
    <nav aria-label="breadcrumb align-items-center">
        <ol class="breadcrumb justify-content-center ">
            ...
            <li class="breadcrumb-item">
                <a href="{{route('membership.admin.nonacademic.nonacademicmembership.index')}}" class="text-decoration-none">Back</a>
            </li>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    ...
                    <select aria-label="Default select example" name="status" class="form-control @error('status') is-invalid @enderror"
                        ...
                        <option @isset($nonacademic_membership){{ $nonacademic_membership->nam_status == 'Active' ? 'selected' : '' }} @endisset>Active</option>
                        <option @isset($nonacademic_membership){{ $nonacademic_membership->nam_status == 'Ended' ? 'selected' : '' }} @endisset>Ended</option>
