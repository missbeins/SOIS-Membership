        ...
        <nav aria-label="breadcrumb align-items-center">
            <ol class="breadcrumb justify-content-center ">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    Organizations / Non-academic Organizations / Membership_details
                </li>
                ...
                <tbody>
                    ...
                    @foreach ($members as $member)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('membership.student-services.showNonacadMemberDetails', $member->non_academic_member_id) }}" type="button" class="btn btn-info"><i class="far fa-eye me-2"></i>Details</a>
                            </td>
