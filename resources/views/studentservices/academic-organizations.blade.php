...
<div class="mt-2">
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive text-center">
                ...
                <tbody>
                    @if ($acadOrgs->isNotEmpty())
                        @foreach ($acadOrgs as $org)
                            <tr>
                                <td scope="row">{{ $loop->iteration }}</td>
                                <td>{{ $org->organization_name }}</td>
                                <td>
                                    <a href="{{ route('membership.student-services.acadOrgsMemberships', $org->organization_id) }}" type="button" class="btn btn-info"><i class="far fa-eye me-2"></i>View memberships</a>
                                </td>
